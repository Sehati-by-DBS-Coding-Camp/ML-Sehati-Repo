...
+-------+--------------------+-------------------------+---------------+
| **Min | **ML Engineer      | **Front-End & Back-End  | **            |
| ggu** | Tasks**            | Tasks**                 | Coordinator** |
+=======+====================+=========================+===============+
| 1     | -   Studi          | -   Desain mockup UI/UX | Nur, Zidan,   |
|       |     literatur      |     awal                | Ary           |
|       |     (indikator     |                         |               |
|       |     psikologis &   | -   API Endpoint Design |               |
|       |     skoring:       |                         |               |
|       |     DASS-21,       | -   Setup environment   |               |
|       |     PHQ-9, GAD-7)  |     frontend dan        |               |
|       |                    |     backend             |               |
|       | -   Eksplorasi dan |                         |               |
|       |     preprocessing  |                         |               |
|       |     data untuk     |                         |               |
...
|       |     (optional)     |                         |               |
+-------+--------------------+-------------------------+---------------+
| 2     | -   Pengembangan   | -   Implementasi        | Alfi, Yoga,   |
|       |     pipeline       |     halaman form        | Ary           |
|       |     skoring        |     self-assessment     |               |
|       |     kuantitatif    |                         |               |
|       |     (misalnya rule | -   Setup struktur      |               |
|       |     based dari     |     database dan API    |               |
|       |     DASS-21)       |     awal                |               |
|       |                    |                         |               |
|       | -   Pelatihan awal |                         |               |
|       |     model          |                         |               |
...
|       |     text)          |                         |               |
+-------+--------------------+-------------------------+---------------+
| 3     | -   Fine-Tune      | -   Koneksi API dan     | Sopian, Yoga, |
|       |     IndoBert dan   |     frontend            | Ary           |
|       |     model internal |                         |               |
|       |     untuk          | -   Integrasi form      |               |
|       |     klasifikasi    |     dengan backend      |               |
|       |     sentimen       |                         |               |
|       |     (positif,      |                         |               |
|       |     negatif,       |                         |               |
|       |     netral)        |                         |               |
...
|       |     internal       |                         |               |
+-------+--------------------+-------------------------+---------------+
| 4     | -   Konversi dan   | -   Integrasi model ke  | Zidan,        |
|       |     export model   |     backend untuk       | Sopian, Ary   |
|       |     untuk          |     inferensi real-time |               |
|       |     penggunaan web |                         |               |
|       |                    | -   Tampilkan hasil     |               |
...
|       |     inferensi      |                         |               |
+-------+--------------------+-------------------------+---------------+
| 5     | -   Finalisasi     | -   Perbaikan UI/UX     | Nur, Alfi,    |
|       |     dokumentasi    |     berdasarkan         | Ary           |
|       |     teknis model   |     feedback            |               |
|       |                    |                         |               |
|       | -   Simulasi       | -   Tambahkan fitur     |               |
|       |     penggunaan     |     artikel edukatif    |               |
|       |     oleh user      |     dan rekomendasi     |               |
|       |     dummy          |     (opsional)          |               |
+-------+--------------------+-------------------------+---------------+
| 6     | -   Revisi akhir   | -   End-to-end testing  | Ary           |
|       |     berdasarkan    |     sistem              |               |
|       |     pengujian      |                         |               |
|       |                    | -   Deployment          |               |
|       |                    |                         |               |
...
![](./image2.png){width="6.5in" height="4.277777777777778in"}
